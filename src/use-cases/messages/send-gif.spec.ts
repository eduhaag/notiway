...
let sut: SendGifUseCase

const addToQueue = vi.spyOn(queue, 'add')

describe('Send Gif use case', () => {
  beforeEach(async () => {
    clientTokensRepository = new InMemoryClientTokensRepository()
    sut = new SendGifUseCase(clientTokensRepository)
  ...
  it('should be able to send a gif', async () => {
    await sut.execute({
  ...
  it('should not be able to gif with a invalid token', async () => {
    expect(async () => {
      await sut.execute({
        url: 'http://example.com',
        to: '9999999',
  ...
  it('should not be able to send gif with a client not ready', async () => {
  ...
  it('should not be able to send gif with a client whithout sender', async () => {
  ...
  it('should not be able to send gif with a client with sender not ready', async () => {
  ...
  it('should not be able to send gif with a client with sender disabled', async () => {
